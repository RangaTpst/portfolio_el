    ...
    <?php foreach ($projects as $project): ?>
      <div class="project-card-wrapper">
        <a href="<?= BASE_URL ?>projet/<?= htmlspecialchars($project['slug'], ENT_QUOTES, 'UTF-8') ?>" class="project-card">
          ...
          <?php
            // Chemin absolu pour le test file_exists
          ...
          <div class="card-overlay">
            ...
            <p><strong>Compétence :</strong> <?= htmlspecialchars($project['competence'] ?? 'Non renseigné', ENT_QUOTES, 'UTF-8') ?></p>
            <p><strong>Tags :</strong> <?= htmlspecialchars($project['tags'] ?? 'Non renseigné', ENT_QUOTES, 'UTF-8') ?></p>
            <p><strong>Date :</strong> <?= !empty($project['date_realisation']) ? htmlspecialchars($project['date_realisation'], ENT_QUOTES, 'UTF-8') : 'Date inconnue' ?></p>
